...
function DetailsCategory() {
  ...
  return (
    <div className="max-w-6xl mx-auto py-10">
      <h1 className="text-4xl font-bold mb-6">{singleCategory.name}</h1>

      <div className="grid gap-5">
        {singleCategory.articles?.map((article) => (
          <div key={article.id} className="bg-white rounded-xl shadow p-5">
